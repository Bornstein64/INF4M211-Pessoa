...
<html>
    ...
    <body>
        ...
        <form action="<?php $cadPJs->updatePJ(); ?>" method="POST">
            ...
            <input type="text" required value="<?php echo $pj[0]['nome']; ?>" name="social"/>
            <br><br>
            <input type="text" required value="<?php echo $pj[0]['nomeFantasia']; ?>" name="fantasia"/>
            <br><br>
            ...
            <br><br>
            <input type="text" value="<?php echo $pj[0]['site']; ?>" name="site"/>
            <br><br>
